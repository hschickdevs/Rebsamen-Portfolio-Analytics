...
from ._config import FINNHUB_RATE_LIMIT
...
class FinnhubClient(finnhub.Client):
    ...
    @sleep_and_retry
    @limits(calls=FINNHUB_RATE_LIMIT[0], period=FINNHUB_RATE_LIMIT[1])
    def call_api(self, func, *args, **kw):
    ...
    def get_company_profile2(self, symbol: str):
        return self.call_api(self.company_profile2, symbol=symbol)
    
    def get_basic_financials(self, symbol: str):
        return self.call_api(self.company_basic_financials, symbol, "all")
